...
export class CustomError extends HttpException {
  /**
   * @param systemCode The stardard code for the system that threw the error. Ex: 'FE_AUTH', etc.
   * @param errorCode The specific error code for the error that was thrown. Ex: 'INVALID_CREDENTIALS', etc.
